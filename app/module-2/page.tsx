    ...
    <div ref={containerRef} className="min-h-screen pt-60 pb-60">
      ...
      {trickVisible && (
        <div className="fixed inset-0 z-99 bg-black/50 backdrop-blur-sm flex items-center justify-center pointer-events-none">
          {/* <div
          ref={trickCardRef}
          className="fixed bottom-1/2 left-1/2 -translate-x-1/2 z-999 w-11/12 max-w-md bg-slate-900 text-white px-6 py-4 rounded-lg shadow-lg text-center text-sm max-sm:text-xs"
        > */}
          <div
            ref={trickCardRef}
